...
void GetAreaDataAddrs(void) {
  ...
  AreaData
      = CONCAT11(AreaDataAddrHigh[(byte)(AreaDataHOffsets[AreaType] + AreaAddrsLOffset)] + (0xfd < bVar1), bVar1 + 2);
  return;
}
...
void PlayerCtrlRoutine(void) {
  ...
  if (GameEngineSubroutine != 0xb) {
    if ((AreaType == 0) && ((PlayerOrSprObject_Y_HighPos[0] != 1 || (0xcf < PlayerOrSprObject_Y_Position[0])))) {
      SavedJoypadBits[0] = 0;
    }
  ...
  PlayerBGCollision();
  if ((((0x3f < PlayerOrSprObject_Y_Position[0]) && (GameEngineSubroutine != 5)) && (GameEngineSubroutine != 7))
...
void ClimbingSub(void) {
  ...
  PlayerOrSprObject_Y_HighPos[0] = PlayerOrSprObject_Y_HighPos[0] + cVar5 + (bVar2 || bVar1 && bVar3 == 0);
  ...
  if (bVar3 != 0) {
    if (ClimbSideTimer == 0) {
      ...
      PlayerOrSprObject_PageLoc[0] = PlayerOrSprObject_PageLoc[0] + ClimbAdderHigh[bVar4]
      ...
      if (((Cannon_Or_Whirlpool_PageLoc[bVar3] != 0)
          ...
          && ((byte)(((Cannon_Or_Whirlpool_PageLoc[bVar3]
                     ...
                     - ((byte)(Cannon_X_Position_Or_Whirlpool_LeftExtent[bVar3]
                               + Cannon_Y_Position_Or_Whirlpool_Length[bVar3])
                        < PlayerOrSprObject_X_Position[0]))
              < 0x80)) {
        ...
        if ((FrameCounter & 1) != 0) {
          if ((byte)(((Cannon_Or_Whirlpool_PageLoc[bVar3]
                      ...
                      - PlayerOrSprObject_PageLoc[0])
                     - (bVar1 < PlayerOrSprObject_X_Position[0]))
              < 0x80) {
  ...
  if (param_1 == 5) {
    ...
    if (7 < VineHeight) {
      ...
      if (0x1f < VineHeight) {
        ...
        bVar2 = sVar6.r02;
        if ((bVar2 < 0xd0) && (RAM(SUBPIECE(sVar6, 4, 2) + (ushort)bVar2) == 0)) {
          RAM(SUBPIECE(sVar6, 4, 2) + (ushort)bVar2) = 0x26;
        }
      }
    }
  }
...
void ImposeGravity(byte param_1, byte param_2, byte param_3, byte param_4, byte param_5) {
  ...
  PlayerOrSprObject_YMF_Dummy[param_2] = PlayerOrSprObject_YMF_Dummy[param_2] + PlayerOrSprObject_Y_MoveForce[param_2];
  cVar4 = 0;
...
byte ProcLoopCommand(byte param_1) {
  ...
  do {
    if ((LoopCommand != 0) && (CurrentColumnPos == 0)) {
      ...
      if (PlayerOrSprObject_Y_Position[0] != LoopCmdYPosition[bVar4]) {
        goto WrongChk;
      }
      if (Player_State != 0) {
        goto WrongChk;
      ...
      if (WorldNumber == 6) {
        ...
        do {
          MultiLoopPassCntr += 1;
          if (MultiLoopPassCntr != 3) {
            goto InitLCmd;
          }
          if (MultiLoopCorrectCntr == 3) {
            goto InitMLp;
          }
          if (MultiLoopCorrectCntr != 3)
            break;
...
void InitShortFirebar(byte param_1) {
  ...
  FireballSpinDirectionOrVictoryDestPageLoc[param_1] = FirebarSpinDirData[(byte)(Enemy_ID[param_1] - 0x1b)];
...
byte ProcHammerBro(byte param_1) {
  ...
  if (Enemy_Y_Position[param_1] < 0x80) {
    bVar2 = 0xfd;
    bVar1 = 1;
    if ((0x6f < Enemy_Y_Position[param_1]) && (bVar1 = 0, (PseudoRandomBitReg[param_1 + 1] & 1) == 0)) {
      bVar2 = 0xfa;
    }
  }
...
byte ProcMoveRedPTroopa(byte param_1) {
  ...
  if (((PlayerSpriteVarData2[param_1 + 1] | CheepCheepOrigYPos_Or_Enemy_Y_MoveForce_Or_PiranhaPlantDownYPos[param_1])
       == 0)
...
NoColFB:
  ...
  if ((PlayerSize != 0) || (bVar2 = 0, abVar3 = PlayerOrSprObject_Y_Position[0], CrouchingFlag != 0)) {
    bVar2 = 2;
...
byte PlayerLakituDiff(byte param_1, byte param_2, byte param_3, byte param_4) {
  ...
  if (((0x3b < bVar1) && (bVar1 = 0x3c, Enemy_ID[param_1] == 0x11)) && (bVar2 != PlayerSpriteVarData2[param_1 + 1])) {
  ...
  if ((PlayerSpriteVarData1[0] != 0) && (ScrollAmount != 0)) {
    ...
    if (((Enemy_ID[param_1] != 0x12) || (PlayerSpriteVarData1[0] == 0)) && (PlayerSpriteVarData2[param_1 + 1] == 0)) {
      cVar3 = 0;
    }
  }
...
void GameTimerFireworks(byte param_1) {
  ...
  if (((GameTimerDisplay[2] != 1) && (bVar1 = 3, GameTimerDisplay[2] != 3)) && (bVar1 = 0, GameTimerDisplay[2] != 6)) {
...
void OffscreenBoundsCheck(byte param_1) {
  ...
  if (Enemy_ID[param_1] != 0x14) {
    bVar1 = Enemy_ID[param_1];
    bVar7 = 4 < bVar1;
    if ((bVar1 == 5) || (bVar7 = 0xc < bVar1, abVar5 = ScreenEdgeOrLeft_X_Pos[0], bVar1 == 0xd)) {
    ...
    if ((0x7f
        ...
        || (((((byte)((Enemy_PageLoc[param_1]
              ...
              && (bVar1 != 0xd))
             && (((bVar1 != 0x30 && (bVar1 != 0x31)) && (bVar1 != 0x32)))))) {
      EraseEnemyObject(param_1);
    }
  }
  return;
  ...
  if ((((!bVar3) && (EnemyOffscrBitsMasked[param_1] == 0)) && (GameEngineSubroutine == 8))
    ...
    if (bVar3) {
      ...
      if ((((0x7f < PlayerSpriteVarData2[0]) || (PlayerSpriteVarData2[0] == 0))
           && ((Enemy_ID[param_1] < 7 || (Enemy_Y_Position[param_1] <= (byte)(PlayerOrSprObject_Y_Position[0] + 0xc)))))
          && (StompTimer == 0)) {
        if (InjuryTimer != 0) {
          return ObjectOffset;
        }
...
byte EnemiesCollision(byte param_1) {
  ...
  bVar1 = Enemy_ID[param_1];
  if ((((bVar1 < 0x15) && (bVar1 != 0x11)) && (bVar1 != 0xd)) && (EnemyOffscrBitsMasked[param_1] == 0)) {
...
BHalf:
  ...
  bVar2 = sVar9.r04;
  bVar5 = sVar9.a;
  if ((((sVar9.z) || (bVar5 == 0x1c)) || (bVar5 == 0x6b)) || (bVar8 = CheckForClimbMTiles(bVar5), bVar8)) {
    goto BHalf;
  }
CheckSideMTiles:
  ...
  if ((param_1 == 0x24) || (param_1 == 0x25)) {
    if (GameEngineSubroutine != 5) {
      ...
      if (GameEngineSubroutine != 4) {
        ...
        do {
          if (FlagpoleYPosData[FlagpoleScore] <= PlayerOrSprObject_Y_Position[0])
            break;
          FlagpoleScore -= 1;
...
// SMB:debd
// Signature: [A] -> [Z]
bool ChkInvisibleMTiles(byte param_1) { return param_1 == 0x5f || param_1 == 0x60; }
...
void HandlePipeEntry(byte param_1, byte param_2) {
  ...
  if ((((Up_Down_Buttons & 4) != 0) && (param_1 == 0x11)) && (param_2 == 0x10)) {
    ...
    if (WarpZoneControl != 0) {
      ...
      bVar2 = bVar1;
      if ((0x5f < PlayerOrSprObject_X_Position[0]) && (bVar2 = bVar1 + 1, 0x9f < PlayerOrSprObject_X_Position[0])) {
        bVar2 = bVar1 + 2;
      }
...
void ImpedePlayerMove(byte param_1) {
  ...
  PlayerOrSprObject_PageLoc[0] = PlayerOrSprObject_PageLoc[0] + cVar3 + CARRY1(bVar1, PlayerOrSprObject_X_Position[0]);
...
struct_ncr00 PlayerEnemyDiff(byte param_1) {
  ...
  sVar3.c = bVar2 && PlayerOrSprObject_PageLoc[0] <= bVar1 || !bVar2 && PlayerOrSprObject_PageLoc[0] < bVar1;
...
byte CheckRightScreenBBox(byte param_1, byte param_2) {
  ...
  if (bVar2 && bVar1 <= PlayerOrSprObject_PageLoc[param_1] || !bVar2 && bVar1 < PlayerOrSprObject_PageLoc[param_1]) {
...
struct_azr02r04r06r07 BlockBufferCollision(byte param_1, byte param_2, byte param_3) {
  ...
  bStack0000 = param_1;
  sVar4 = GetBlockBufferAddr((byte)((byte)(BlockBuffer_X_Adder[param_3] + PlayerOrSprObject_X_Position[param_2]) >> 1
                                    | (PlayerOrSprObject_PageLoc[param_2]
                                       + CARRY1(BlockBuffer_X_Adder[param_3], PlayerOrSprObject_X_Position[param_2]))
                                          * -0x80)
                             >> 3);
...
byte EnemyGfxHandler(byte param_1) {
  ...
  if (((Enemy_ID[param_1] == 0xd) && (PlayerSpriteVarData1[param_1 + 1] < 0x80)) && (EnemyFrameTimer[param_1] != 0)) {
    return param_1;
  }
...
SkipToOffScrChk:
  ...
  if (VerticalFlipFlag != 0) {
    ...
    bVar3 = bVar4 - 2;
    bVar2 = bVar3;
    if (((MysterySpriteThing4 != 5) && (MysterySpriteThing4 != 0x11)) && (MysterySpriteThing4 < 0x15)) {
      bVar2 = bVar4 + 6;
    }
...
CheckToMirrorLakitu:
  ...
  Sprite_Data[bVar3 + 10] = 0x82;
  Sprite_Data[bVar3 + 0x12] = 0x82;
  Sprite_Data[bVar3 + 0xe] = 0xc2;
  Sprite_Data[bVar3 + 0x16] = 0xc2;
  bVar3 = SprObjectOffscrChk();
  return bVar3;
}
...
void RenderPlayerSub(byte param_1) {
  ...
  DrawPlayerLoop(PlayerGfxOffset, PlayerOrSprDataOffset[0], PlayerOrSprObject_Rel_YPos[0], PlayerFacingDir,
                 Player_SprAttrib, PlayerOrSprObject_Rel_XPos[0], param_1);
  return;
}
...
byte GetXOffscreenBits(byte param_1) {
  ...
  do {
    ...
    if ((bVar1 < 0x80) && (bVar2 = DefaultXOnscreenOfs[bVar3 + 1], 0x7f < (byte)(bVar1 - 1))) {
      bVar2 = DividePDiff(8, bVar2, bVar3, 0x38, ScreenEdgeOrLeft_X_Pos[bVar3] - PlayerOrSprObject_X_Position[param_1]);
    }
...
byte GetYOffscreenBits(byte param_1) {
  ...
  do {
    bVar1
        = (1 - PlayerOrSprObject_Y_HighPos[param_1]) - (HighPosUnitData[bVar3] < PlayerOrSprObject_Y_Position[param_1]);
    bVar2 = DefaultYOnscreenOfs[bVar3];
    if ((bVar1 < 0x80) && (bVar2 = DefaultYOnscreenOfs[bVar3 + 1], 0x7f < (byte)(bVar1 - 1))) {
      bVar2 = DividePDiff(4, bVar2, bVar3, 0x20, HighPosUnitData[bVar3] - PlayerOrSprObject_Y_Position[param_1]);
    }
...
PTone1F:
    ...
    if (Squ1_SfxLenCounter != 0x24) {
      if (Squ1_SfxLenCounter == 0x1e) {
        goto PTone1F;
      }
      if (Squ1_SfxLenCounter != 0x18) {
        goto DecPauC;
      }
    }
    bVar1 = 100;
...
struct_axy AlternateLengthHandler(byte param_1) {
  ...
  sVar1 = ProcessLengthData(((param_1 << 1 | param_1 & 1) << 1 | param_1 >> 7) << 1 | (byte)(param_1 << 1) >> 7);
  sVar2.y = sVar1.y;
  sVar2.a = sVar1.a;
  sVar2.x = param_1;
  return sVar2;
...
struct_ayi ProcessLengthData(byte param_1) {
  ...
  bVar1 = (param_1 & 7) + NoteLenLookupTblOfs + NoteLengthTblAdder + CARRY1(param_1 & 7, NoteLenLookupTblOfs);
  sVar2.y = bVar1;
